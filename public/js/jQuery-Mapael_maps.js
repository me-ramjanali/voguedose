...
$(function () {
	$(".mapcontainer").mapael({
		map: {
			...
			defaultArea: {
				attrs: {
					fill: "url('datas/images/white-dot.svg')"
					, stroke: "transparent"
				}
			}
...
$(function () {
	...
	$world.mapael({
		...
		plots: $.extend(true, {}, data[2016]['plots'], plots),
		areas: data[2016]['areas']
	});
});
...
// Map 3
    ...
    $(function () {
            ...
            $('#refresh_usa').on('click', function () {

                // and delete some others ...
                var deletedPlots = ["paris", "lyon"];

                $(".usa_states").trigger('update', [{
...
$(function () {
    ...
    slider.on('set', function(values){
        ...
        $(".usa_states_2").trigger("showElementsInRange", [opt]);
        $(".values").text("Population between " + parseInt(values[0]) + " and " + parseInt(values[1]) + " inhabitants");
    });
