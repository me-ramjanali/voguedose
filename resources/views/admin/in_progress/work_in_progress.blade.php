                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($req->process_status < 4)
                                <td><a id="complete" href="{{ URL::to('admin/complete/'.$req->id) }}" class="btn btn-success"><i class="fa fa-check-circle"></i> Complete</a></td>
                            @endif
                        </tr>
                        @endforeach
                    </tbody>
...
@include('admin.in_progress.js.in_progress_js')
@endsection
