...
<div id="page-content-wrapper">
    <div class="container-fluid">
        ...
        @endif
        <form id="profile" method="post" action="{{ URL::to('admin/update_profile') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <!-- row -->
            <div class="row">
                <div class="profile">
                                        ...
                                        <div class="profile-line">
                                            <div class="profile-picture">
                                                @if($user_info->picture != '')
                                                    <img src="{{ URL::asset('uploads/admin_picture/'.$user_info->picture) }}" class="img-responsive" alt="avatar">
                                                @else
...
@include('admin.auth.js.profile_update_js')
@endsection
