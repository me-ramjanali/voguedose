...
<div id="page-content-wrapper">
    ...
    <div class="row">
        <div class="col-md-9 products-pagination text-right">
            ...
            <a id="accept" href="{{ URL::to('styler/accept/'.$order_info->id) }}" class="btn btn-success"><i class="fa fa-check-circle"></i> Acceept</a>
            <a id="reject" href="{{ URL::to('styler/reject/'.$order_info->id) }}" class="btn btn-inverse"><i class="fa fa-trash-o"></i>  Decline</a>
            @endif
        </div>
    </div>
    <!-- #row -->
...
@include('styler.order.js.common_js')
@endsection