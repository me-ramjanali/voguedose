@extends('styler.layouts.login_layout')
        ...
        <div class="col-md-4 col-md-push-4 col-xs-12 sign-box" style="margin-top: 91.1429px;">
            <div class="panel panel-default pale-panel-border-top">
                ...
                <div class="panel-body">
                    <br>
                    <form class="form" role="form" method="POST" action="{{ url('styler/login') }}">
                        {{ csrf_field() }}
                    ...
                    <div class="text-right">
                        <small><a class="text-danger" href="{{ url('styler/password/reset') }}">Forgot Password?</a><small>
                    </small>
                </div>
            </div>
        </div>
